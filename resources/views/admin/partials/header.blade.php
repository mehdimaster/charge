...
<head>
    ...
    <link href='{{staticAsset("assets/css/bootstrap.min.css")}}' rel="stylesheet" type="text/css">
    <link href='{{staticAsset("assets/css/bootstrap-theme.min.css")}}' rel="stylesheet" type="text/css">
    <link href='{{staticAsset("assets/css/font-awesome.min.css")}}' rel="stylesheet" type="text/css">
    <link href='{{staticAsset("assets/css/admin/fa/xenon-core.css")}}' rel="stylesheet" type="text/css">
    <link href='{{staticAsset("assets/css/admin/linecons/css/linecons.css")}}' rel="stylesheet" type="text/css">
    <script src='{{staticAsset("assets/js/admin/jquery-1.11.1.min.js")}}'></script>
        ...
        <div class="row">
                ...
                <div class="user-info">
                    ...
                    <div class="user-image">
                        <a href="extra-profile.html">
                            <img src="{{staticAsset('assets/gfx/admin/user-2.png')}}" class="img-responsive img-circle" />
                        </a>
                    </div>
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-links">
                            <a href="extra-profile.html" class="btn btn-primary">{{trans('admin.editProfile')}}</a>
                            <a href="extra-profile.html" class="btn btn-success">{{trans('admin.upgrade')}}</a>
                        </div>
            ...
            <div class="col-md-8 link-blocks-env">
                ...
                <div class="links-block left-sep">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            ...
                            <label for="sp-chk1">{{trans('admin.messages')}}</label>
                        </li>
                        <li>
                            <input type="checkbox" class="cbr cbr-primary" checked="checked" id="sp-chk2" />
                            <label for="sp-chk2">{{trans('admin.events')}}</label>
                        </li>
                        <li>
                            <input type="checkbox" class="cbr cbr-primary" checked="checked" id="sp-chk3" />
                            <label for="sp-chk3">{{trans('admin.updates')}}</label>
                        </li>
                        <li>
                            <input type="checkbox" class="cbr cbr-primary" checked="checked" id="sp-chk4" />
                            <label for="sp-chk4">{{trans('admin.serverUptime')}}</label>
                        </li>
                    </ul>
                </div>
                ...
                <div class="links-block left-sep">
                    <h4>
                        <a href="#">
                            <span>{{trans('admin.helpDesk')}}</span>
                        </a>
                    </h4>
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="#">
                                ...
                                {{trans('admin.supportCenter')}}
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa-angle-right"></i>
                                {{trans('admin.submitTicket')}}
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa-angle-right"></i>
                                {{trans('admin.domainsProtocol')}}
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa-angle-right"></i>
                                {{trans('admin.termsOfService')}}
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <header class="logo-env">
                ...
                <div class="logo">
                    <a href="dashboard-1.html" class="logo-expanded">
                        <img src="{{staticAsset('assets/gfx/admin/user-4.png')}}" width="80" alt="" />
                    </a>

                    <a href="dashboard-1.html" class="logo-collapsed">
                        <img src="{{staticAsset('assets/gfx/admin/user-2.png')}}" width="40" alt="" />
                    </a>
                </div>
            ...
            <ul id="main-menu" class="main-menu">
                    ...
                    <ul>
                        <li class="">
                            <a href="{{url("admin/report")}}">
                                ...
                                <span class="title">گزارشات شارژ</span>
                            </a>
                        </li>
                ...
                {{--<li>
                    <a href="">
                        ...
                        <span class="title">{{trans('admin.imageGallery')}}</span>
                    </a>
                    <ul>
                        <li>
                            <a href="{{url("gfx/admin/imagegallery")}}">
                                <span class="title">{{trans('admin.edit')}}</span>
                            </a>
                        </li>
                ...
                <li>
                    <a href="">
                        <i class="linecons-note"></i>
                        <span class="title">{{trans('admin.userPermissions')}}</span>
                    </a>
                    <ul>
                        <li>
                            <a href="{{url("gfx/admin/permission")}}">
                                <span class="title">{{trans('admin.userList')}}</span>
                            </a>
                        </li>
                ...
                <li>
                    <a href="">
                        ...
                        <span class="title">Agency detail</span>
                    </a>
                    <ul>
                            <li>
                                <a href="{{url("gfx/admin/user/agency/add")}}">
                                    <span class="title">Agency add</span>
                                </a>
                            </li>
                            <li>
                            <a href="{{url("gfx/admin/user/agency/showAll")}}">
                                <span class="title">Agency edit</span>
                            </a>
                            </li>
                ...
                <li>
                    <a href="{{url("gfx/admin/superadmin")}}">
                        <i class="linecons-database"></i>
                        <span class="title">Add super admin</span>
                    </a>
        ...
        <nav class="navbar user-info-navbar" role="navigation">
            ...
            <ul class="user-info-menu right-links list-inline list-unstyled">
                ...
                <li class="dropdown user-profile">
                    <a href="#" data-toggle="dropdown">
                        <img src="{{staticAsset('assets/gfx/admin/user-4.png')}}" alt="user-image" class="img-circle img-inline userpic-32" width="28" />
							<span>
								Arlind Nushi
                    ...
                    <ul class="dropdown-menu user-profile-menu list-unstyled">
                        ...
                        <li>
                            <a href="{{url("gfx/admin/updateagency")}}">
                                <i class="fa-user"></i>
                                Profile
                            </a>
                        </li>
